        ...
        <form role="form" action="update.php" method="post">
          <div class="card-body">
            <div class="form-row">
              ...
              <input type="text" class="form-control" id="mem_username" name="mem_username" value="<?php echo $row['mem_username']?>" hidden>
              ...
              <div class="form-group col-md-4">
                  ...
                  <input type="email" class="form-control" id="mem_email" name="mem_email"  value="<?php echo $row['mem_email']?>"disabled>
              </div>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control" id="mem_address" name="mem_address"  rows="5"disabled> <?php echo $row['mem_address']?></textarea>
            </div>
