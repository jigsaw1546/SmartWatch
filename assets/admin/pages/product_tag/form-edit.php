          ...
          <div class="card-body">
            ...
            <table>
              ...
              <div class="form-group col-md-4">
                  ...
                  <input type="text" class="form-control" id="product_tag_id" name="product_tag_id" value="<?php echo $row['product_tag_id']?>" disabled>
              </div>
              <div class="form-group col-md-4">
                  <label for="product_tag_name">Product Tag Name</label>
                  <input type="text" class="form-control" id="product_tag_name" name="product_tag_name"value="<?php echo $row['product_tag_name']?>"disabled>
              </div>
              <div class="form-group col-md-1">
                  <label for="submit" style="opacity: 0;">submit</label><br>
                  <a href="form-edit2.php?product_tag_id=<?php echo $row['product_tag_id']?>"class="btn btn-warning float-right">แก้ไขข้อมูล</a>
              </div>
