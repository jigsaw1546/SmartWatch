        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Add Shoes Size </li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    ...
    <section class="content">
      ...
      <div class="card">
        <div class="card-header">
          <h3 class="card-title d-inline-block">Add Shoes Size </h3>
        </div>
        <!-- /.card-header -->
          ...
          <div class="card-body">
            ...
            <table>
              ...
              <div class="form-group col-md-4">
                  ...
                  <input type="text" class="form-control" id="shoes_size" name="shoes_size">
              </div>
              <div class="form-group col-md-4">
                  <label for="shoes_name">Shoes Name</label>
                  <input type="text" class="form-control" id="shoes_name" name="shoes_name">
              </div>
