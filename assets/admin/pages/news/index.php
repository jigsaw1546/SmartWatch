        ...
        <div class="card-body">
          <table id="dataTable" class="table table-bordered table-striped w-100 ">
            ...
            <tr>
              ...
              <th>Title</th>
              <th>Date</th>
              <th><a href="form_insert.php" class="btn btn-info"><i class="fas fa-plus-square"></i> Add News</a></th>
            </tr>
            </thead>
            <tbody>
            <?php while($row=mysqli_fetch_array($res)) { ?>
              <tr>
                ...
                <td><img src="../../../image/news/<?php echo $row['new_image']?>" class="img-fluid d-block mx-auto rounded-circle"  width="80"></td>
                <td><?php echo $row['new_title']; ?></td>
                <td><?php echo $row['new_date']; ?></td>
                <td>
                  <a href="form-edit.php?new_id=<?php echo $row['new_id']; ?>" class="btn btn-sm btn-warning text-white">
                    <i class="fas fa-edit"></i> edit
                  </a> 
                  <a href="delete.php?new_id=<?php echo $row['new_id']?>" onClick="return confirm('คุณต้องการลบข้อมูลนี้หรือไม่');" class="btn btn-sm btn-danger">
