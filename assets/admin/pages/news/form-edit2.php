...
?>
      ...
      <div class="card">
        ...
        <form role="form" action="update.php" method="post"enctype="multipart/form-data"id="formRegister">
          <div class="card-body">
              ...
              <div class="form-group col-md-6">
                  <label for="mem_fname">Add Image News</label>
                    <div class="custom-file">
                        ...
                        <input type="hidden" class="form-control" id="new_id" name="new_id" value="<?php echo $rows['new_id']?>">
                        <input type="hidden" class="form-control" id="new_image1" name="new_image1" value="<?php echo $rows['new_image']?>">
            ...
            <table>
              <div class="form-group col-md-2">
                  ...
                  <input type="text" class="form-control" id="new_title" name="new_title" value="<?php echo $rows['new_title']?>">
              </div>
              <div class="form-group col-md-2">
                  <label for="new_date">Date</label>
                  <input type="date" class="form-control" id="new_date" name="new_date" value="<?php echo $rows['new_date']?>">
              </div>
          ...
          <a href="form-edit.php?new_id=<?php echo $rows['new_id']?>"class="btn btn-warning float-right">ย้อนกลับ</a>
 ...
 $('.custom-file-input').on('change', function(){
  ...
  $( document ).ready(function(){
            $('#formRegister').validate({
                ...
                messages:{
                  new_title: 'โปรดกรอก หัวข้อข่าว',
                  new_date: 'โปรดเลือกวันที่',
                },
                errorElement: 'div',
